...
data_performances = {
    ...
    "Voting Regressor": joblib.load('code/vr_performance.pkl'),
    "Stacking Regressor": joblib.load('code/stackreg_performance.pkl'),
    "XGBoost": joblib.load('code/xgb_cv_performance.pkl'),
    "Random Forest Regressor": joblib.load('code/rfr_cv_performance.pkl')
}
...
train_df = load_data("data/train_df.csv")
test_df = load_data("data/test_df.csv")
train_df_labelled = load_data("data/train_df_labelled.csv")
test_df_labelled = load_data("data/test_df_labelled.csv")
